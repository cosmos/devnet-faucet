...
A comprehensive faucet system for Cosmos EVM networks that supports both Cosmos and EVM environments with the same underlying keys, enabling seamless dual-environment token distribution and testing.

## Overview

Faucet with suport for both Cosmos and Ethereum Virtual Machine (EVM) wallets on Cosmos EVM chains.
...
- ull support across both environments
